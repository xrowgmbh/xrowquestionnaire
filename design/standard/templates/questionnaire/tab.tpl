    <div id="tabelement" class="question_{literal}{$id}{/literal} question_tabs">
        <ul class="draggable">
        ...
        <div id="tabs-1_{$id}">
            ...
            <button class="button" type="button" onclick="remove({literal}{$id}{/literal});">Frage entfernen</button>
        </div>
        <div id="tabs-2_{$id}">
