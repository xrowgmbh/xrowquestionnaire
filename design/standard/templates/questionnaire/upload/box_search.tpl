{def $box_embed_mode = false()
     $box_classes = fetch( 'class', 'list', hash( 'sort_by', array( 'name', true() ) ) )
     $box_has_access = fetch( 'user', 'has_access_to', hash( 'module', 'questionnaire',
                                                             'function', 'search' ) )} 
<div class="panel" id="search_box" style="position: relative;">
{if $box_embed_mode}
...
{undef $box_embed_mode $box_classes $box_has_access}